...
- **Virker i dag:** komplet 2/3/4-vejs simulering med komplekse overføringsfunktioner, CEA-2034 spinorama, Harman/Olive preference-score, auto-optimizer (kun dæmpning, bånd 0 låst), EQ-filtre, biquad-eksport (MiniDSP 2x4 / 4x10 HD) + CamillaDSP YAML + byggeark, wizard-flows for alle tre indgange (kabinet→drivere med 8-dels forklarlig score, drivere→kabinet, fra bunden), kabinetberegner med **7 kabinettyper** (lukket/ported/passiv slave/bandpass/TL/horn/åben baffel) på den ægte lumped-element/T-matrix-motor, alignment-startpunkter (QB3/SBB4/B4/EBS + numerisk flat-optimering), excursion/porthastighed/maks-SPL, T/S-konsistensflag, 3D-kabinetbygger + STL, OS waveguide-designer, PDF/graf-digitizer, 37 drivere, projekt-gem/indlæs, A/B-sammenligning, design-dashboard med status-badge og samlede "Anvend"-advarsler (alle 7 kabinettyper), FRD/ZMA-import med A/B/C kvalitetsflag, reverse-null-test, Equalizer APO-eksport, dashboard-faner (Spinorama/Delefilter/Impedans/Excursion & port) med "Hvorfor ser det sådan ud?"-annotationslag, design-versionering (snapshots med parent_version), Hypex FusionAmp + ADAU/SigmaStudio-eksport, akustiske mål-slopes (elektrisk filter fittes mod akustisk LR2/BW4/LR4/LR8-mål på baffle-korrigerede råkurver), Kabinet-fane i dashboardet (inline-redigering, stående bølger, panelresonans), OpenSCAD/DXF-eksport af baffeludskæring, positionsafhængig kant-diffraktionsmodel (edge-integral med driverplaceringer + roundover-dæmpning — ripple, ikke kun 6 dB-shelf), off-axis-diffraktion pr. vinkel i spinorama (LW/ER/SP/DI/PIR afhænger af driverplaceringer og roundover, delta-model uden dobbelt-påføring), Baffelstep-kortet viser kantmodellens kurver pr. enhed (analytisk 6 dB-step kun som stiplet reference), monteringsoverrides pr. bånd (fast frontposition eller sidemontering — faste positioner driver diffraktion/spinorama/CAD, sidemonterede enheder falder ærligt tilbage til generisk baffelstep), indbyggede presets med Kudos X2 (3-vejs: Vifa BC25TG15-04 + Wavecor WF146WA02 + sidemonteret ScanSpeak 18W/4424G00 i det målte 720×165×205-kabinet) og Mk3 Reference (3-vejs aktiv fra mk3-reference-loudspeaker-repoet: 2× GRS 12SW-4HE push-push sidemonteret z=520, ScanSpeak 18W/4424G00 front z=1065, SB26STAC-C000-4 under midten z=901, 300×420×1180 lukket ~75 L, R19, XO 200 BW4/1100 LR4, gains 0/−4/−9 — mid-kammer 13 L, waveguide og Linkwitz Transform modelleres ikke), bruger-Vb for lukkede kabinetter (Fc/Qtc/F3 udledes af alfa = Vas/Vb med Vas × antal drivere; gælder sim, kabinetkort, A/B-sammenligning og kabinetoptimizer — 0 = auto Qtc 0.707), mount-bevidst tidsjustering (auto-delay og Tidsjusteringskortet regner kun på frontmonterede enheder — sidemonterede udelades ærligt i stedet for at stå som falsk 0 mm-reference; preset-delays forudberegnet) og forskudt frontbaffel pr. bånd (mekanisk plan-forskydning z indgår i akustisk dybde og fasesummering, egne delbaffel-mål giver båndet sin egen kantdiffraktion — to-plans front kan designes og tidsjusteres mekanisk). 548 tests.
- **Under opbygning (se ROADMAP):** golden tests mod WinISD/Hornresp-CSV (eksterne kørsler), rum-lag (SPEC §4.14).
